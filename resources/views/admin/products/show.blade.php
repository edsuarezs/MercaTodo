...
@section('admin-content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button-toolbar key-nav aria-label="{{ __('Products toolbar') }}">
                <button-group class="ml-1">
                    <button href="{{ route('admin.products.edit', $product) }}" variant="success" size="sm">
                        <i class="fas fa-fw fa-edit"></i> {{ __('Edit') }}
                    </button>
                    <button variant="danger" size="sm" action="{{ route('admin.products.destroy', $product) }}">
